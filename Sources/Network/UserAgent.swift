...
public enum UserAgent {
    ...
    public static let value: String = "\(sdkName)/\(sdkVersion) (\(osName) \(osVersion)) \(executableName)"
    ...
    public static let extended: String = "\(appNameAndVersion) \(deviceName) \(deviceVersion) \(cfNetworkVersion) \(darwinVersion)"
}
